	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float3 ase_viewVectorTS =  tanToWorld0 * ( _WorldSpaceCameraPos.xyz - ase_worldPos ).x + tanToWorld1 * ( _WorldSpaceCameraPos.xyz - ase_worldPos ).y  + tanToWorld2 * ( _WorldSpaceCameraPos.xyz - ase_worldPos ).z;
				float3 ase_viewDirTS = normalize( ase_viewVectorTS );
				float4 temp_output_7_0 = ( ( ( tex2D( _EmissiveTex, uv_EmissiveTex ) * _EmissiveColor ) * _EmissionIntencity ) + ( texCUBE( _Cubemap, refract( ase_viewDirTS , tex2DNode2 , _RefractionCubemap ) ) * _FakeReflections ) );
		...
		Pass
        {
			...
			UNITY_SETUP_INSTANCE_ID(packedInput);
				...
				float4 tex2DNode3 = tex2D( _MainTex, uv_MainTex );
				float2 uv_DifOpacityMask = packedInput.ase_texcoord7.xy * _DifOpacityMask_ST.xy + _DifOpacityMask_ST.zw;
				float lerpResult76 = lerp( 0.0 , _Opacity_Add , tex2D( _DifOpacityMask, uv_DifOpacityMask ).g);
				float2 uv_Opacity_MasterMask = packedInput.ase_texcoord7.xy * _Opacity_MasterMask_ST.xy + _Opacity_MasterMask_ST.zw;
				float clampResult77 = clamp( tex2D( _Opacity_MasterMask, uv_Opacity_MasterMask ).g , _Opacity_Min , 1.0 );
				float Opacity47 = ( ( ( tex2DNode3.a * _Opacity_Tex_Multiply ) + lerpResult76 ) * clampResult77 );
...
Node;AmplifyShaderEditor.SamplerNode;52;-1506.51,-320.1326;Inherit;True;Property;_DifOpacityMask;DifOpacityMask;9;0;Create;True;0;0;0;False;0;False;-1;6394cf7ba98889942988282150124412;6394cf7ba98889942988282150124412;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;3;-1537.522,-756.418;Inherit;True;Property;_MainTex;Main Tex;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;49;-1189.16,-243.9995;Inherit;True;Property;_Opacity_MasterMask;Opacity_MasterMask;10;0;Create;True;0;0;0;False;0;False;-1;abc00000000013220669993734470830;abc00000000013220669993734470830;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;2;-1620.721,147.1063;Inherit;True;Property;_NormalTex;Normal Tex;4;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;4;-828.9915,391.7336;Inherit;False;Property;_EmissiveColor;Emissive Color;6;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;5;-1451.118,-924.2438;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=801EB4FA0F08D411D57CA0C6CE986E2A27A5CE12